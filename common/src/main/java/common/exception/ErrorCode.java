...
public enum ErrorCode {
    ...
    COMPETITION_CANNOT_CANCEL_REGISTRATION(HttpStatus.CONFLICT, "COMPETITION_CANNOT_CANCEL_REGISTRATION", "준비 중인 대회에서만 신청을 취소할 수 있습니다."),
    COMPETITION_CANNOT_PUBLISH(HttpStatus.CONFLICT, "COMPETITION_CANNOT_PUBLISH", "준비 중인 대회만 공개할 수 있습니다."),
    COMPETITION_PARTICIPANT_COUNT_CANNOT_DECREASE(HttpStatus.CONFLICT, "COMPETITION_PARTICIPANT_COUNT_CANNOT_DECREASE", "현재 참가자가 없어 취소할 수 없습니다."),
    COMPETITION_REGISTER_PERIOD_START_AFTER_END(HttpStatus.BAD_REQUEST, "COMPETITION_REGISTER_PERIOD_START_AFTER_END", "신청 시작일은 신청 종료일보다 이전이어야 합니다."),
    COMPETITION_REGISTER_START_IN_PAST(HttpStatus.BAD_REQUEST, "COMPETITION_REGISTER_START_IN_PAST", "신청 시작일은 현재 시각 이후여야 합니다."),
    COMPETITION_PERIOD_START_AFTER_END(HttpStatus.BAD_REQUEST, "COMPETITION_PERIOD_START_AFTER_END", "대회 시작일은 대회 종료일보다 이전이어야 합니다."),
    COMPETITION_PERIOD_START_IN_PAST(HttpStatus.BAD_REQUEST, "COMPETITION_PERIOD_START_IN_PAST", "대회 시작일은 현재 시각 이후여야 합니다."),
    COMPETITION_REGISTER_END_AFTER_COMPETITION_START(HttpStatus.BAD_REQUEST, "COMPETITION_REGISTER_END_AFTER_COMPETITION_START", "신청 종료일은 대회 시작일보다 이전이어야 합니다."),
    COMPETITION_PARTICIPANT_MIN_EXCEEDS_MAX(HttpStatus.BAD_REQUEST, "COMPETITION_PARTICIPANT_MIN_EXCEEDS_MAX", "최소 참가 인원은 최대 참가 인원보다 클 수 없습니다."),
    COMPETITION_PARTICIPANT_COUNT_NEGATIVE(HttpStatus.BAD_REQUEST, "COMPETITION_PARTICIPANT_COUNT_NEGATIVE", "참가 인원 수는 0 이상이어야 합니다."),
    COMPETITION_CHANGE_NOTICE_BEFORE_CONTENTS_REQUIRED(HttpStatus.BAD_REQUEST, "COMPETITION_CHANGE_NOTICE_BEFORE_CONTENTS_REQUIRED", "변경 전 내용은 필수입니다."),
    COMPETITION_CHANGE_NOTICE_AFTER_CONTENTS_REQUIRED(HttpStatus.BAD_REQUEST, "COMPETITION_CHANGE_NOTICE_AFTER_CONTENTS_REQUIRED", "변경 후 내용은 필수입니다."),
    COMPETITION_CHANGE_NOTICE_REASON_REQUIRED(HttpStatus.BAD_REQUEST, "COMPETITION_CHANGE_NOTICE_REASON_REQUIRED", "변경 사유는 필수입니다."),
