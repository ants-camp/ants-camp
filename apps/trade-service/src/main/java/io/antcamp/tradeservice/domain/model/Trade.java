...
public record Trade(
    ...
    /** 신규 주문 생성 (PENDING 상태) */
    public static Trade create(UUID tradeId, UUID accountId, TradeType tradeType,
                               LocalDateTime tradeAt, String stockCode, int stockAmount,
                               double totalPrice, OrderType orderType, Double limitPrice) {
        return new Trade(
                tradeId, accountId, tradeType, tradeAt, stockCode, stockAmount,
     ...
     */
    public static Trade fromPersistence(UUID tradeId, UUID accountId, TradeType tradeType,
                                        LocalDateTime tradeAt, String stockCode, int stockAmount,
    ...
    public static Trade updateSuccess(Trade trade) {
        return new Trade(
                trade.tradeId, trade.accountId, trade.tradeType, trade.tradeAt,
